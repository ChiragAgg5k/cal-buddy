...
export default function TasksComponent({ newTask, addTask, newTaskPriority, setNewTask, setNewTaskPriority, taskFilter, setTaskFilter, filteredTasks, toggleTaskCompletion, deleteTask}: TasksComponentProps) {
    return (
        <Card>
            <CardHeader>
